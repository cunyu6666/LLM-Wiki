📎 来源：[`wiki/design/AI实操与工具.md`] → Skill 生态与上下文工程段
📎 原始素材：[`Cubox/Anthropic终于公开了他们内部Skill方法论-2026-06-08.md`]
...
📎 来源：[`Cubox/设计 SKILL：提取网站规范 DESIGN md 和 HTML 预览-2026-06-05.md`]
...
📎 来源：[`Cubox/测评：海外设计大神分享，最强UI-UX界面设计skill-2026-05-27.md`]
...
📎 来源：[`wiki/design/设计方法论.md`] → Overview 段
📎 原始素材：[`Cubox/上下文（情境）工程：用设计思维重构 AI 协作逻辑和方式-2026-06-05.md`]
...
📎 来源：[`Cubox/Agentic Workflow：AI重塑了我的工作流-2026-06-03.md`]
...
📎 来源：[`wiki/design/设计师成长.md`] → AI 时代的角色转型段
📎 原始素材：[`raw/design/2024-08-28-笑哭了设计师的圣诞树…`]
...
📎 来源：[`Cubox/设计走查这个苦活，我终于用AI跑通了全自动-2026-06-01.md`]

#### 3.4 不需要"从零学编程"

**Vibe Coding 的本质：用自然语言描述意图，AI 生成代码**

📎 来源：[`wiki/design/AI编程与Vibe Coding.md`] → Overview 段

> "从来没有一款所谓的'最好'的工具，只有最适合你思考、设计及构建方式的工具。"

📎 来源：[`wiki/design/设计师成长.md`] → AI 时代的角色转型段
📎 原始素材：[`raw/design/2026-01-08-值得每一位新时代设计师尝试的 8 款 Vibe Coding AI 应用.md`]
...
📎 来源：[`wiki/design/设计师成长.md`] → Overview 段
...
| 场景 | 推荐工具 | 上手难度 | 来源 |
|------|----------|----------|------|
| 快速原型 | Claude Design / v0 | ⭐ | 📎 [`wiki/design/AI设计工具.md`] |
| 前端开发 | Cursor + Tailwind + shadcn/ui | ⭐⭐⭐ | 📎 [`wiki/design/AI编程与Vibe Coding.md`] |
| Agent 交互设计 | Claude Code + MCP | ⭐⭐⭐⭐ | 📎 [`wiki/design/AI Agent 开发.md`] |
| 设计系统 AI 化 | DESIGN.md + Design Tokens | ⭐⭐ | 📎 [`wiki/design/设计系统.md`] |
...
📎 来源：[`wiki/design/AI编程与Vibe Coding.md`] → Claude Code 与可视化段

> Huashu Design（14.9K Star）：一句话出设计，让 Claude Code 变身大厂设计团队

📎 来源：[`wiki/design/AI编程与Vibe Coding.md`] → Claude Code 与可视化段
📎 原始素材：[`Cubox/一句话出设计！14.9K Star 的开源神器Huashu Design…`]
...
📎 来源：[`wiki/design/AI实操与工具.md`] → Overview 段
...
| 2   | "不写代码的设计师将成为团队瓶颈。"                                            | OpenAI 设计师 · 📎 [`AI编程与Vibe Coding.md`]                                                                 |
| 3   | "执行交给 AI，判断留给人。"                                              | 📎 [`UX与交互研究.md`] Overview                                                                                         |
| 4   | "最稀缺的能力不是写代码，而是知道该写什么代码。"                                     | 演讲者原创                                                                                                                                    |
| 5   | "除了设计师，谁最适合 Build？"                                           | 演讲者原创                                                                                                                                    |
| 6   | "不能被 Agent 用的产品没有未来。"                                         | Notion Ivan Zhao · 📎 [`AI Agent 开发.md`]                                                                   |
| 7   | "设计师不只为用户设计，还要为智能体设计。"                                        | 📎 [`UX与交互研究.md`]                                                                                                  |
| 8   | "不是 AI 替代了创作者，而是 AI 覆盖掉他们不擅长的那部分。"                            | Ryo Lu · 📎 [`AI编程与Vibe Coding.md`]                                                                     |
| 9   | "Prompt 设计好比网页设计。"                                            | Cursor 团队 · 📎 [`AI编程与Vibe Coding.md`]                                                                  |
| 10  | "未来十年没有 AGI，只有 Agent。"                                        | Karpathy · 📎 [`AI Agent 开发.md`]                                                                           |
| 11  | "没有验证机制的野心，顶多算个愿望而已。"                                         | Jason Liu · 📎 [`Cubox/OpenAI大神教你如何榨干Codex…`]                                             |
| 12  | "AI 帮你量尺寸、比颜色、数像素，这些都是尺子的活。"                                  | 📎 [`Cubox/设计走查这个苦活…`]                                                                  |
| 13  | "目利き——一眼就能看出好坏的那种眼力。"                                         | 📎 [`Cubox/设计走查这个苦活…`]                                                                  |
| 14  | "行业 Know-how 就像冰山，冰山下的不可被观测的，才是这个时代个人的竞争力。"                   | 📎 [`Cubox/Agentic Workflow…`]                                                  |
| 15  | "Reshape your workflow with AI? or Reshape your AI workflow?" | 📎 [`Cubox/Agentic Workflow…`]                                                  |
| 16  | "AI 已经不是插件，而是设计流程的基础设施。"                                      | 📎 [`Cubox/AI in Design Report 2026…`]                  |
| 17  | "更像代码实习生拿到需求后做了一层思考并自主推进，只不过速度快 10 倍。"                        | 📎 [`Cubox/MiniMax M3 首发体验…`]                                   |
| 18  | "最终我们要教模型的，和我们教孩子的是同一件事。"                                     | 📎 [`Cubox/Claude Code之父…`]                                      |
| 19  | "想法即产品，设计即代码。"                                                | QoderWork Design Desk · 📎 [`raw/来自抖音/想法即产品…`] |
| 20  | "5 个人，7 天做出 QoderWork。"                                       | 📎 [`raw/Uncategorized/2026-04-12-…对谈谢吉宝…`]            |
| 21  | "UED 不是给高保真图，而是直接把设计变成组件放进代码库。"                               | 📎 同上                                                                                                                                    |
| 22  | "我不是'转行做了工程师'，我还是设计师——只是设计师的工作方式变了。"                          | 演讲者原创（基于 QoderWork 实践）                                                                                                                   |
| 23  | "过去 20 年设计师弥合'执行鸿沟'，未来 20 年设计师弥合'评估鸿沟'。"                      | John Maeda · 📎 [`Cubox/2026科技中的设计报告…`]                                |
| 24  | "设计师要以设计为根，向 AI 能力和工程能力两个方向生长——成为树型设计师。"                      | John Maeda · 📎 同上                                                                                                                       |
| 25  | "好的设计 = 高熟悉度 + 高新颖度，这需要运气、直觉与文化的积累。"                          | John Maeda · 📎 同上                                                                                                                       |
| 26  | "人跨得过去，工具才能跨得过去。"                                             | Tolaria 作者 · 📎 [`Cubox/1.1万 Star…`]                                                 |
| 27  | "它不是帮你偷一个网站的样子，而是帮你理解一个好网站到底是怎么被组织起来的。"                       | rico · 📎 [`Cubox/设计 SKILL…`]                                 |
| 28  | "韧性 > 效率：效率让系统脆弱，冗余让系统有韧性。"                                   | John Maeda · 📎 [`Cubox/2026科技中的设计报告…`]                                |
...
| wiki 文章 | 引用段落 | 路径 |
|-----------|----------|------|
| AI设计工具 | Claude Design、Codex、Lovart、系统提示词泄露 | [`wiki/design/AI设计工具.md`] |
| AI编程与Vibe Coding | Ryo Lu、Cursor、Codex Annotation、Prompt 设计、工作流 | [`wiki/design/AI编程与Vibe Coding.md`] |
| AI Agent 开发 | Karpathy、Ivan Zhao、Agent 概念、Bridge、HAX | [`wiki/design/AI Agent 开发.md`] |
| 设计系统 | Design Tokens、DESIGN.md、AI 可读规范 | [`wiki/design/设计系统.md`] |
| 设计方法论 | 上下文工程、Figma VP、Prompt = 设计思维 | [`wiki/design/设计方法论.md`] |
| UX与交互研究 | UX→AX、HAX、CHI 论文、执行交给AI | [`wiki/design/UX与交互研究.md`] |
| 设计师成长 | Vercel 团队、圣诞树、DeepSeek、Vibe Coding 8 款应用 | [`wiki/design/设计师成长.md`] |
| 前端实现 | Tailwind/shadcn 新主流、AI 入侵前端 | [`wiki/design/前端实现.md`] |
| AI实操与工具 | Anthropic Skill 方法论、上下文工程、工作流 | [`wiki/design/AI实操与工具.md`] |
| UI设计与组件 | 8 个 AI 时代产品设计模式 | [`wiki/design/UI设计与组件.md`] |

### 引用的原始素材（Cubox / raw）

| 原始素材 | 路径 |
|----------|------|
| Cursor Composer 2.5 拆解 | [`Cubox/Cursor Composer 2.5 拆解…`] |
| Vercel 设计团队新工作流 | [`Cubox/Vercel 设计团队…`] |
| Claude Design 发布 | [`raw/design/2026-04-18-Claude-Design-发布…`] |
| Claude Design 系统提示词泄露 | [`raw/design/2026-04-24-暴击设计行业的…`] |
| open-codesign 开源替代品 | [`raw/design/2026-04-25-open codesign…`] |
| Codex Annotation 更新 | [`Cubox/Codex 这次更新…`] |
| 3 个人 10 周做 Claude Design | [`Cubox/3 个人、10 周…`] |
| Agent 时代 UI 不是壳是边界 | [`Cubox/Agent时代…`] |
| 8 个 AI 时代产品设计模式 | [`Cubox/值得收藏关注的…`] |
| Anthropic Skill 方法论 | [`Cubox/Anthropic终于公开了…`] |
| 上下文情境工程 | [`Cubox/上下文（情境）工程…`] |
| Karpathy 2 小时访谈 | [`raw/…/Andrej-Karpathy-2小时访谈…`] |
| Agent 产品快者为王 | [`raw/…/Agent产品快者为王…`] |
| Bridge 首次发声 | [`raw/…/Bridge首次发声…`] |
| 设计师的圣诞树 | [`raw/design/2024-08-28-笑哭了…`] |
| 8 款 Vibe Coding 应用 | [`raw/design/2026-01-08-值得每一位…`] |
| Huashu Design | [`Cubox/一句话出设计！…`] |
| **🆕 OpenAI 大神榨干 Codex** | [`Cubox/OpenAI大神教你如何榨干Codex-2026-05-23.md`] |
| **🆕 设计走查全自动** | [`Cubox/设计走查这个苦活…`] |
| **🆕 Agentic Workflow 重塑工作流** | [`Cubox/Agentic Workflow…`] |
| **🆕 HTML版剪映 3天3万行** | [`Cubox/HTML版剪映来了！…`] |
| **🆕 AI in Design Report 2026** | [`Cubox/AI in Design Report 2026…`] |
| **🆕 MiniMax M3 首发体验** | [`Cubox/MiniMax M3 首发体验…`] |
| **🆕 Claude Code 之父** | [`Cubox/Claude Code之父…`] |
| **🆕 Claude 设计负责人** | [`Cubox/Claude 设计负责人…`] |
| **🆕 Anthropic 产品负责人** | [`Cubox/Anthropic产品负责人…`] |
| **🆕 QoderWork 对谈（5人7天）** | [`raw/Uncategorized/2026-04-12-我们还是低估了AI-Coding的真正天花板…`] |
| **🆕 QoderWork Design Desk** | [`raw/来自抖音/想法即产品设计即代码 QoderWork…`] |
| **🆕 2026科技中的设计报告（Maeda）** | [`Cubox/2026科技中的设计报告 - 从UX到AX…`] |
| **🆕 Tolaria（10万行代码全AI写）** | [`Cubox/1.1万 Star，又一款笔记工具火出圈了！…`] |
| **🆕 rico-design-md（设计SKILL）** | [`Cubox/设计 SKILL：提取网站规范…`] |
| **🆕 UI/UX 设计 Skill 测评** | [`Cubox/测评：海外设计大神分享…`] |
